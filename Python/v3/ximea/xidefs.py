...
XI_USER_SET_SELECTOR = { 
    "XI_US_DEFAULT": c_uint(0),    #Default factory preset.
    "XI_US_USERSET1": c_uint(1),    #User Set 1 created by user.
    ...
    "XI_US_2_12_CMS_L": c_uint(14),    #12bit per channel, 2 samples,  CMS Low Gain mode preset.
    "XI_US_2_12_CMS_H": c_uint(15),    #12bit per channel, 2 samples,  CMS High Gain mode preset.
    "XI_US_2_14_CMS_L": c_uint(16),    #14bit per channel, 2 samples,  CMS Low Gain mode preset.
    "XI_US_2_14_CMS_H": c_uint(17),    #14bit per channel, 2 samples,  CMS High Gain mode preset.
    "XI_US_4_12_CMS_L": c_uint(18),    #12bit per channel, 4 samples,  CMS Low Gain mode preset.
    "XI_US_4_12_CMS_H": c_uint(19),    #12bit per channel, 4 samples,  CMS High Gain mode preset.
    "XI_US_4_14_CMS_L": c_uint(20),    #114bit per channel, 4 samples,  CMS Low Gain mode preset.
    "XI_US_4_14_CMS_H": c_uint(21),    #14bit per channel, 4 samples,  CMS High Gain mode preset.
